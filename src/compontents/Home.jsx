...
function Home() {
  return (
    <div
      id="home"
      className="pt-20 max-w-screen-2xl container mx-auto px-4 md:px-20 my-28"
    >
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
        ...
        <div className="space-y-6 mt-12 md:order-2">
          ...
          <p className="text-lg text-gray-700 transition duration-300 hover:underline">
            I focus on creating stylish and modern websites, online stores, and
            educational platforms tailored to meet the needs of schools and
            institutions. My goal is to deliver user-friendly and visually
            appealing solutions that enhance online experiences.
          </p>
          ...
          <div className="flex justify-center mt-4 space-x-4">
            ...
            <a
              href="https://drive.google.com/file/d/1b8PlQ-S0nGr4ex4uLOh3J6BOz8GN6-zE/view?usp=drive_link"
              target="_blank"
              rel="noopener noreferrer"
              className="bg-red-600 text-white py-2 px-4 rounded-lg shadow-lg hover:bg-red-700 transition duration-200 transform hover:scale-105"
            >
              Video CV
            </a>
          </div>
          ...
          <div className="flex flex-col md:flex-row justify-between items-center space-y-6 md:space-y-0 mt-6">
            <div className="space-y-2">
              ...
              <ul className="flex space-x-5 justify-center">
                {[
                  {
                    href: "https://github.com/Garv1981",
                    icon: <FaGithubSquare className="text-2xl" />,
                  },
                  {
                    href: "https://www.linkedin.com/in/garvgakkhar2004",
                    icon: <FaLinkedin className="text-2xl" />,
                  },
                  {
                    href: "https://t.me/Garv014",
